...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUIResize-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUIResize-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUIResize-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUIResize-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUIResize-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUIResize-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugEffectGUIResize-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugEffectGUIResize.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugEffectGUIResize.iss",inplace=1):
