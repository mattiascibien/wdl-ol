...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairoGraphics-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairoGraphics-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairoGraphics-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairoGraphics-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairoGraphics-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairoGraphics-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugEffectCairoGraphics-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugEffectCairoGraphics.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugEffectCairoGraphics.iss",inplace=1):
