...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUILiveEdit-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUILiveEdit-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUILiveEdit-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUILiveEdit-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUILiveEdit-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectGUILiveEdit-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugEffectGUILiveEdit-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugEffectGUILiveEdit.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugEffectGUILiveEdit.iss",inplace=1):
