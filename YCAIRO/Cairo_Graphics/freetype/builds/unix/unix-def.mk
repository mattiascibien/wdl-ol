...
MKINSTALLDIRS   := /Users/Youlean/Documents/IPlug-Youlean/YCAIRO/Cairo_Graphics/freetype/builds/unix/./install-sh -c -d
...
LIBS_PRIVATE       := 
LIBSSTATIC_CONFIG  := -lfreetype -L/opt/local/lib -lz -L/opt/local/lib -lpng16 -lz
build_libtool_libs := 
ft_version         := 22.0.16
